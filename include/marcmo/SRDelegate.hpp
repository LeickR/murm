 ...
 *
 * Modifications added by Leick Robinson:
 *  - added the "numParams" constant to see the parameter count for the delegate
 *    (useful in templates for error checking).
 *
 * Reference:
 ...
 *
 *
 * This public domain code is part of the Cpp-Delegate-Library-Collection which
 * under an "Unlicense" license:
 * -------------------------------------------------------------------------
...
#pragma once
#ifndef SR_DELEGATE_HPP
# define SR_DELEGATE_HPP
...
namespace generic
{
    ...
    public:
        static const std::size_t numParams = sizeof...(A);
